...
#' per code. Must have columns named exactly as in `qual_indicators`, and a `Code` column.
#' @param qual_indicators A character vector of quality indicator names to plot
#' (e.g., `c("Priority excerpt", "Heterogeneity")`). These determine which
...
#'  (e.g., `c("Priority excerpt" = 20, "Heterogeneity" = 30)`). Codes with
