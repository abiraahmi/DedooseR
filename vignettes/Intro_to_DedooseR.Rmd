---
title: "Introduction to DedooseR"
...
Please note: In your dataset, every theme or code is prefixed with "c_". The variable labels 
drop this so your outputs are user-friendly, but to call specific codes, you need to include this "c_".
To familiarize yourself with the variables in your dataset, review the codebook.
